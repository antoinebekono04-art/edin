...
import 'package:eden/data_model/classified_ads_details_response.dart';
...
import 'package:eden/ui_elements/classified_product_mini_card.dart';
...
class _ClassifiedAdsDetailsState extends State<ClassifiedAdsDetails>
  ...
  fetchProductDetails() async {
    ...
    if (productDetailsResponse.data!.isNotEmpty) {
      ...
      for (var element in _productDetails!.photos!.data!) {
