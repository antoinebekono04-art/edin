import 'package:eden/custom/dash_divider.dart';
          ...
          ListTile(
            ...
            onTap: () async {
              ...
              if (stepIndex == 1) {
                // DELIVERY STEP
                if (isGuest) {
                  bool success = await provider.submitGuestAddress();
                  if (!success) return;
                } else {
    ...
    return Column(
      children: [
        TextField(
          ...
          onChanged: (val) {
            provider.clearNameError(isBilling: isBilling);
          },
        ...
        TextField(
          ...
          onChanged: (val) {
            provider.clearAddressError(isBilling: isBilling);
          },
          decoration: guestInputDecoration(
            "Address *",
            errorText: isBilling
        ...
        TextField(
          ...
          onChanged: (val) {
            provider.clearPhoneError(isBilling: isBilling);
          },
          decoration: guestInputDecoration(
            "Phone Number *",
            errorText: isBilling
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<dynamic>(
                              ...
                              isExpanded: true,
                              decoration: editInputDecoration(),
                              initialValue: checkoutProvider.selectedCountry,
                              hint: const Text(
                                "Select Country",
                                style: TextStyle(
                                  fontSize: 12,
                      ...
                      DropdownButtonFormField<dynamic>(
                        ...
                        isExpanded: true,
                        decoration: editInputDecoration(),
                        initialValue: checkoutProvider.selectedState,
                        hint: const Text(
                          "Select State",
                          style: TextStyle(fontSize: 12, color: Colors.grey),
                        ),
                      ...
                      DropdownButtonFormField<dynamic>(
                        ...
                        isExpanded: true,
                        decoration: editInputDecoration(),
                        initialValue: checkoutProvider.selectedCity,
                        hint: const Text(
                          "Select City",
                          style: TextStyle(fontSize: 12, color: Colors.grey),
                        ),
                      ...
                      if (checkoutProvider.areaList.isNotEmpty ||
                        ...
                        DropdownButtonFormField<dynamic>(
                          ...
                          isExpanded: true,
                          decoration: editInputDecoration(),
                          initialValue: checkoutProvider.selectedArea,
                          hint: Text(
                            checkoutProvider.isAreaLoading
                                ? "Loading Areas..."
                                : "Select Area",
