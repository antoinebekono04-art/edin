...
class LastViewProduct extends StatefulWidget {
  const LastViewProduct({super.key});
        ...
        child: MasonryGridView.count(
          ...
          itemBuilder: (context, index) {
            ...
            return ProductCard(
              ...
              image: _lastViewProducts[index].thumbnailImage,
              name: _lastViewProducts[index].name,
              mainPrice: _lastViewProducts[index].mainPrice,
              strokedPrice: _lastViewProducts[index].strokedPrice,
              hasDiscount: _lastViewProducts[index].hasDiscount ?? false,
