...
import 'package:eden/data_model/currency_response.dart';
...
import 'package:eden/presenter/currency_presenter.dart';
...
class CurrencyChange extends StatefulWidget {
  const CurrencyChange({super.key});

  @override
  State<CurrencyChange> createState() => _CurrencyChangeState();
}
        ...
        return SingleChildScrollView(
          child: ListView.separated(
            separatorBuilder: (context, index) {
              return SizedBox(height: 14, width: 10);
            },
