...
class InhouseProducts extends StatefulWidget {
  const InhouseProducts({super.key});
...
class _InhouseProductsState extends State<InhouseProducts> {
  ...
  fetchData() async {
    var productResponse = await ProductRepository().getInHouseProducts(
      page: _page,
    );
          ...
          child: MasonryGridView.count(
            ...
            itemBuilder: (context, index) {
              return ProductCard(
                ...
                image: _inhouseProductList[index].thumbnailImage,
                name: _inhouseProductList[index].name,
                mainPrice: _inhouseProductList[index].mainPrice,
                strokedPrice: _inhouseProductList[index].strokedPrice,
                hasDiscount: _inhouseProductList[index].hasDiscount,
