...
class _PaytmScreenState extends State<PaytmScreen> {
  ...
  paytm() {
    String initialUrl =
        "${AppConfig.BASE_URL}/paytm/payment/pay?payment_type=${widget.paymentType}&combined_order_id=$_combinedOrderId&amount=${widget.amount}&user_id=${user_id.$}&package_id=${widget.packageId}&order_id=${widget.orderId}";
