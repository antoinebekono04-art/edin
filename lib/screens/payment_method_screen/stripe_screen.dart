...
class _StripeScreenState extends State<StripeScreen> {
  ...
  stripe() {
    String initialUrl =
        "${AppConfig.BASE_URL}/stripe?payment_type=${widget.paymentType}&combined_order_id=$_combinedOrderId&amount=${widget.amount}&user_id=${user_id.$}&package_id=${widget.packageId}&order_id=${widget.orderId}";
