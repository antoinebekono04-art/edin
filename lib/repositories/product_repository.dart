...
import 'package:eden/data_model/category.dart';
import 'package:eden/data_model/product_details_response.dart';
import 'package:eden/data_model/product_mini_response.dart';
import 'package:eden/data_model/variant_response.dart';
...
import 'package:eden/data_model/wholesale_model.dart';
...
class ProductRepository {
  ...
  Future<ProductMiniResponse> getDigitalProducts({
    ...
    String url =
        ("${AppConfig.BASE_URL}/products/search?page=1&name=$name&sort_key=$sortKey&brands=$brands&categories=&min=$min&max=$max&digital=$page");
  ...
  Future<ProductDetailsResponse> getProductDetails({
    ...
    String url = ("${AppConfig.BASE_URL}/products/$slug/$userId");
