...
import 'package:eden/data_model/flash_deal_response.dart'
    hide Product;
import 'package:eden/data_model/product_mini_response.dart';
import 'package:eden/data_model/category_response.dart';
import 'package:eden/data_model/slider_response.dart';
import 'package:eden/repositories/category_repository.dart';
import 'package:eden/repositories/flash_deal_repository.dart';
import 'package:eden/repositories/product_repository.dart';
import 'package:eden/repositories/sliders_repository.dart';
import 'package:eden/single_banner/model.dart';
...
class HomePresenter extends ChangeNotifier {
  ...
  late Animation<double> piratedLogoAnimation;
  ...
  initPiratedAnimation(vnc) {
    piratedLogoController = AnimationController(
      vsync: vnc,
      duration: Duration(milliseconds: 2000),
    );

    piratedLogoAnimation = Tween<double>(begin: 40, end: 60).animate(
      CurvedAnimation(parent: piratedLogoController, curve: Curves.bounceOut),
    );
